...
"""
    ...
    Asterisk AGI NUANCE NR Application
...
class NuanceSRAPP:
    ...
    def __init__(self, options):
        ...
        self.status = None
        self.cause = None
        self.prompt =" Welcome to Nuance speech transcription PLease say digits from 1-3 "
    ...
    def compose_speech_grammar(self):
        ...
        grammar = '/opt/unimrcp/data/grammar.xml'
        separator = '?'
    ...
    def get_prompt(self):
        ...
        prompt = agi.get_variable('RECOG_INSTANCE(0/0/SWI_literal)')
        
        # root = ET.fromstring(prompt)
        # prompt=root.findall('.//instance/response_messages/text/text')
    ...
    def run(self):
        ...
        while processing:
            ...
            if self.status == 'OK':
                if self.cause == '000':
                    self.prompt = "you said " +self.get_prompt()
...
agi = AGI()
options = 'plt=1&b=1&sct=1000&sint=15000&nit=10000&p=ums'
